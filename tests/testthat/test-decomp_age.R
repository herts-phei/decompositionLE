test_that("checks input is in correct format", {
  ...
  expect_error(decomp_age(df_test_fct, method = "arriaga3", age_col = "Age",
                          e1 = "e1x", e2 = "e2x", l1 = "l1x", l2 = "l2x"))
  df_test_prop <- us_females
  df_test_prop$l1x[1] <- 2
  expect_error(decomp_age(df_test_prop, method = "arriaga3", age_col = "Age",
                          e1 = "e1x", e2 = "e2x", l1 = "l1x", l2 = "l2x"))
  df_test_num <- us_females
  df_test_num$l2x <- as.character(df_test_num$l2x)
  expect_error(decomp_age(df_test_num, method = "arriaga3", age_col = "Age",
                          e1 = "e1x", e2 = "e2x", l1 = "l1x", l2 = "l2x"))
...
test_that("checks that example data matches the paper", {
  ...
  df_test <- decomp_age(us_females, method = "arriaga3", age_col = "Age",
                        e1 = "e1x", e2 = "e2x", l1 = "l1x", l2 = "l2x") |>
    mutate(Age = recode(Age,
                        ...
                        "10" = "15", "15" = "15",
                        "20" = "25", "25" = "25",
                        "30" = "45", "35" = "45", "40" = "45", "45" = "45",
                        "50" = "65", "55" = "65", "60" = "65", "65" = "65",
                        "70" = "85+", "75" = "85+", "80" = "85+", "85+" = "85+")) |>
    group_by(Age) |>
  ...
  expect_equal(df_test, ponnapalli_arriaga3_results)
