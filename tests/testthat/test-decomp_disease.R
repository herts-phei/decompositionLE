...
test_that("checks that example data matches the paper", {
  ...
  preston_box4.3_results <- data.frame(
    ...
    delta_CD = c(5.6, 0.8, 0.3, 0.6, 0.8, 0.3, -0.3),
    delta_NCD = c(5.5, 0.6, 0.4, 0.6, 0.7, 0.5, 0.7),
    delta_Injuries = c(-0.0, 0.2, -0.0, 0.1, 0.1, -0.0, -0.1))
  ...
  expect_equal(df_test, preston_box4.3_results)
